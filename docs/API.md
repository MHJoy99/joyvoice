...
| `JV_API_BASE` | ❌ No | `https://ai.bdx.market/v1` | Override the gateway base URL. Useful for self-hosted proxies or migrating gateways. |
...
def cloud_llm_rewrite(text: str, style: str) -> str:
    ...
    payload = json.dumps({
        "model": FAST_MODEL,  # "gemini-3.1-flash-lite"
